...
pkgrel=1
makedepends=("linux-headers=4.14.12-1" "spl-linux-headers")
arch=("x86_64")
...
license=("CDDL")
depends=("kmod" "spl-linux" "zfs-utils-common=0.7.5" "linux=4.14.12-1")
...
package_zfs-linux-headers() {
    ...
    sed -i "s+${srcdir}++" ${pkgdir}/usr/src/zfs-*/4.14.12-1-ARCH/Module.symvers
}
